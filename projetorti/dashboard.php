      ...
      <div class="card-deck">
        ...
        <div class="card">
          ...
          <div class="card-footer ">
            <small class="text-muted"><p>Ultima atualização <?= $sensor1_data ?> | <?= $sensor1_hora ?></p></small>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="card-footer">
            <small class="text-muted"><p>Ultima atualização <?= $sensor2_data ?> | <?= $sensor2_hora ?></p></small>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="card-footer">
            <small class="text-muted"><p>Ultima atualização <?= $sensor3_data ?> | <?= $sensor3_hora ?></p></small>
          </div>
        </div>
      </div><br>
        ...
        <div class="card-deck">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <small class="text-muted"><p>Ultima atualização <?= $atuador1_data ?> | <?= $atuador1_hora ?></p></small>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <small class="text-muted"><p>Ultima atualização <?= $atuador2_data ?> | <?= $atuador2_hora ?></p></small>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <small class="text-muted"><p>Ultima atualização <?= $atuador3_data ?> | <?= $atuador3_hora ?></p></small>
              </div>
            </div>
          </div>
          </div>
